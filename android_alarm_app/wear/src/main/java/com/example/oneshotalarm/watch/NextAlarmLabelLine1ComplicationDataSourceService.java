...
public class NextAlarmLabelLine1ComplicationDataSourceService extends ComplicationDataSourceService {
    @Override
    ...
    public ComplicationData getPreviewData(@NonNull ComplicationType type) {
        return AlarmComplicationData.previewLabelLine(true, 0);
    }
}
