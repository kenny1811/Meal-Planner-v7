...
public class NextAlarmLabelLine2ComplicationDataSourceService extends ComplicationDataSourceService {
    @Override
    public void onComplicationRequest(
        ...
        try {
            listener.onComplicationData(AlarmComplicationData.buildLabelLine(this, true, 1));
    ...
    public ComplicationData getPreviewData(@NonNull ComplicationType type) {
        return AlarmComplicationData.previewLabelLine(true, 1);
    }
}
